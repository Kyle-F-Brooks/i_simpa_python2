...
# Handles "All Sources" & "Create a line of sound sources"  on right click menu of "Sound sources"
...
class manager:
    def __init__(self):
        ...
        self.show_grp_namesid=ui.application.register_event(self.show_grp_names)
        self.hide_grp_namesid=ui.application.register_event(self.hide_grp_names)
